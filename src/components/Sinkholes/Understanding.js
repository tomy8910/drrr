    ...
    return (
      <div>
        ...
        <Paragraph>
          ...
          as salt, gypsum, limestone, dolomite, and other materials that belong
          to the evaporate or carbonate classes of rocks. Acidic water
          underground and rainwater dissolve the rocks and form underground
          passages called <strong>conduits</strong>. The conduits help develop
          underground basins known as recharge areas, which in turn contribute
...
export default SinkholeUnderstanding
